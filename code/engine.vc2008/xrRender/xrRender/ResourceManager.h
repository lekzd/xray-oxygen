...
private:
	...
	/*
		//map_Matrix m_matrices; Это вообще не нужно
		//	map_Constant m_constants; Это тоже, если матрицы в shader.xr есть, но они нигде не используются, то этого вообще в shader.xr нет!!
	*/
