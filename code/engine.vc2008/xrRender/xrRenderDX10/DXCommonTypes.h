...
//	typedef D3D11_QUERY_DESC				D3D_QUERY_DESC;			<< Use the #ifndef for stability work 
...
typedef	D3D12_USAGE							D3D_USAGE;

//	typedef ID3D11RasterizerState				ID3DRasterizerState;	<< Use the #ifndef for stability work 
...
typedef	ID3D12RenderTargetView					ID3DRenderTargetView;
typedef	ID3D12DepthStencilView					ID3DDepthStencilView;
typedef	ID3D12ShaderResourceView				ID3DShaderResourceView;
//	typedef	ID3D11Query								ID3DQuery;
typedef	ID3D12Device							ID3DDevice;
typedef ID3D12DeviceContext						ID3DDeviceContext;
...
#define	D3D_QUERY_EVENT							D3D11_QUERY_HEAP_TYPE
#define	D3D_QUERY_OCCLUSION						D3D11_QUERY_HEAP_TYPE_OCCLUSION
