...
typedef D3D12_CBUFFER_TYPE				D3D_CBUFFER_TYPE;

typedef ID3D12ShaderReflection							ID3DShaderReflection;
typedef	ID3D12ShaderReflectionConstantBuffer			ID3DShaderReflectionConstantBuffer;
typedef	ID3D12ShaderReflectionVariable					ID3DShaderReflectionVariable;
typedef	ID3D12ShaderReflectionType						ID3DShaderReflectionType;
