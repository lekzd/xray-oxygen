...
typedef	ID3D11RenderTargetView					ID3DRenderTargetView;		//D3D12_CPU_DESCRIPTOR_HANDLE RenderTargetView or Resource
typedef	ID3D11DepthStencilView					ID3DDepthStencilView;		//D3D12_CPU_DESCRIPTOR_HANDLE DepthStencilView or Resource
...
#define	D3D_PRIMITIVE_TOPOLOGY_UNDEFINED		D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED			//#VERTVER: WITHOUT ANALOG IN D3D12
